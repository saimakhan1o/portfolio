...
function Professional() {
  const { content, updateProfessionalData, removeSampleData } = useContext(
    ResumeContext
  );
    ...
    <div className="">
      ...
      >
        ...
        <TextField
          ...
          name="resp1[0]"
          variant="outlined"
          defaultValue={content.professional.resp1[0]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{ marginTop: 12, marginLeft: 8, marginRight: 8 }}
        />
        <TextField
          ...
          name="resp1[1]"
          variant="outlined"
          defaultValue={content.professional.resp1[1]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{ marginTop: 12, marginLeft: 8, marginRight: 8 }}
        />
        <TextField
          ...
          name="resp1[2]"
          variant="outlined"
          defaultValue={content.professional.resp1[2]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{
            marginTop: 12,
        ...
        <TextField
          ...
          name="resp2[0]"
          variant="outlined"
          defaultValue={content.professional.resp2[0]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{ marginTop: 12, marginLeft: 8, marginRight: 8 }}
        />
        <TextField
          ...
          name="resp2[1]"
          variant="outlined"
          defaultValue={content.professional.resp2[1]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{ marginTop: 12, marginLeft: 8, marginRight: 8 }}
        />
        <TextField
          ...
          name="resp2[2]"
          variant="outlined"
          defaultValue={content.professional.resp2[2]}
          inputRef={register}
          onChange={handleSubmit(onSubmit)}
          style={{ marginTop: 12, marginLeft: 8, marginRight: 8 }}
        />
